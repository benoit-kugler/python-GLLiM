...
def main():
    ...
    exp, gllim = Experience.setup(context.LabContextOlivineWLinear, 40, partiel=(0, 1, 2, 3), with_plot=True,
...
if __name__ == '__main__':
    ...
    # RTLS()
    main()
    # exp = Experience(context.LabContextOlivine)
    # p = exp.archive._base_dir("figures")
    # Yobs = exp.context.get_observations()
    # pyplot.plot(Yobs)
    # pyplot.savefig(p + "/observations.png")
    # monolearning()
    # test_map()
